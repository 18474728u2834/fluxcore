...
export const ALL_PERMISSIONS = [
  ...
  { key: "edit_roles", label: "Edit Roles", description: "Assign or change a member's Fluxcore workspace role" },
  { key: "manage_members", label: "Manage Members", description: "Issue warnings and remove members" },
