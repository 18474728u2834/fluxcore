      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-sm prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            ...
            <p>Fluxcore is operated by <strong>RetailPro Technologies UIA</strong> (UK) from 25.06.2026. For privacy-related questions or to exercise your rights under this policy, use the <button onClick={() => navigate("/feedback")} className="text-primary hover:underline">Feedback page</button>, email <a href="mailto:support@fluxcore.works" className="text-primary hover:underline">support@fluxcore.works</a>, or contact us through the support center.</p>
          </section>
