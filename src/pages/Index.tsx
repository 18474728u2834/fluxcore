    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative pt-36 pb-24 overflow-hidden">
        ...
        <div className="hidden lg:block pointer-events-none">
          ...
          <div className="absolute left-6 top-40 w-72 rounded-2xl border border-border/20 bg-card/50 backdrop-blur-xl p-5 shadow-2xl shadow-primary/10 animate-fade-up" style={{ animationDelay: "300ms" }}>
            <div className="flex items-center gap-2 mb-4">
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
              <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Live Activity</p>
            </div>
            {[
              ...
              <div key={a.name} className="flex items-center justify-between py-2.5 border-t border-border/10 first:border-t-0">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary to-violet-600 flex items-center justify-center text-xs font-black text-white">{a.name[0].toUpperCase()}</div>
                  <div>
                    <p className="text-sm font-semibold text-foreground leading-tight">{a.name}</p>
                    <p className="text-xs text-muted-foreground leading-tight">{a.action}</p>
                  </div>
                </div>
          ...
          <div className="absolute left-10 top-[28rem] w-64 rounded-2xl border border-border/20 bg-card/50 backdrop-blur-xl p-5 shadow-2xl shadow-primary/10 animate-fade-up" style={{ animationDelay: "500ms" }}>
            <div className="flex items-center justify-between mb-3">
              <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Weekly Quota</p>
              <span className="text-xs font-black text-emerald-400">+12%</span>
            </div>
            <p className="text-3xl font-black text-foreground mb-3">8.5h <span className="text-sm font-medium text-muted-foreground">/ 10h</span></p>
          ...
          <div className="absolute right-6 top-36 w-72 rounded-2xl border border-border/20 bg-card/50 backdrop-blur-xl p-5 shadow-2xl shadow-primary/10 animate-fade-up" style={{ animationDelay: "400ms" }}>
            <div className="flex items-center gap-2 mb-3">
              <Calendar className="w-4 h-4 text-primary" />
              <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Next Shift</p>
            </div>
            <p className="text-base font-bold text-foreground mb-1">Training Session</p>
            <p className="text-sm text-muted-foreground mb-4">Today · 8:00 PM EST</p>
            <div className="flex -space-x-2 mb-2">
              ...
              <div className="w-8 h-8 rounded-full bg-muted border-2 border-background flex items-center justify-center text-xs font-bold text-muted-foreground">+3</div>
            </div>
            <p className="text-xs text-muted-foreground">7 staff claimed</p>
          </div>

          {/* Right bottom: rank card */}
          <div className="absolute right-10 top-[28rem] w-64 rounded-2xl border border-border/20 bg-card/50 backdrop-blur-xl p-5 shadow-2xl shadow-primary/10 animate-fade-up" style={{ animationDelay: "600ms" }}>
            <div className="flex items-center gap-2 mb-3">
              <Shield className="w-4 h-4 text-primary" />
              <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Rank Update</p>
            </div>
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-500 to-cyan-500 flex items-center justify-center text-sm font-black text-white">K</div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-bold text-foreground truncate">kai</p>
                <p className="text-xs text-muted-foreground">Trainee → Officer</p>
              </div>
            </div>
            <p className="text-xs text-emerald-400 font-semibold mt-2">✓ Synced to Roblox</p>
          </div>
        </div>
