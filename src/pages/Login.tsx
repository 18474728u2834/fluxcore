            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-2.5">
                ...
                >
                  ...
                  {redirecting === "roblox" ? "Redirecting to Roblox…" : "Continue with Roblox"}
                </Button>
                ...
                <Button
                  ...
                  disabled={!!redirecting}
                  className="w-full h-12 text-[15px] font-semibold rounded-xl bg-white/[0.04] hover:bg-white/[0.08] text-foreground border border-white/10"
                >
                  {redirecting === "discord" ? (
                    <Loader2 className="w-5 h-5 mr-2 animate-spin" />
                  ) : (
                    <svg className="w-5 h-5 mr-2 text-[#5865F2]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  ...
                  {redirecting === "discord" ? "Redirecting to Discord…" : "Continue with Discord"}
                </Button>
                ...
                <div className="relative py-1">
                  ...
                  <div className="relative flex justify-center text-[10px] uppercase tracking-[0.18em]">
                    <span className="bg-[#0c0e12] px-3 text-muted-foreground/80">Or</span>
                  </div>
                </div>
                ...
                <Button
                  ...
                  variant="ghost"
                  className="w-full h-12 rounded-xl text-[15px] text-muted-foreground hover:text-foreground hover:bg-white/[0.04] press-shrink"
                >
