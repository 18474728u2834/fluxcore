...
export default function ShoplyLogin() {
  ...
  useEffect(() => {
    document.title = "Sign In · Shoply Shopping";
    (async () => {
      try {
        const r = await fetch(
  ...
  return (
    <div className="min-h-screen flex bg-[#04101c] text-white">
      {/* Left brand panel */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-sky-500/20 via-[#04101c] to-emerald-500/15" />
        <div className="absolute inset-0 bg-grid opacity-[0.05]" />
        <div
          className="absolute -top-32 -left-20 w-[500px] h-[500px] rounded-full bg-sky-500/25 blur-[140px] animate-pulse"
          style={{ animationDuration: "6s" }}
        />
        <div
          className="absolute bottom-0 right-0 w-[450px] h-[450px] rounded-full bg-emerald-400/15 blur-[130px] animate-pulse"
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          <div className="flex items-center gap-3 animate-fade-in">
            {groupIcon ? (
              <img src={groupIcon} alt="" className="w-11 h-11 rounded-xl ring-1 ring-white/15" />
            ) : (
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-sky-300 to-sky-600 ring-1 ring-white/15 flex items-center justify-center">
                <ShoppingBasket className="w-5 h-5 text-white" />
              </div>
            )}
            <div className="flex flex-col leading-none">
              <span className="text-lg font-bold tracking-wide">SHOPLY</span>
              <span className="text-[10px] text-sky-300/70 tracking-[0.25em] mt-0.5">SHOPPING</span>
            </div>
          </div>

          <div className="space-y-6 stagger-fade">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-400/10 border border-emerald-400/25 text-[11px] uppercase tracking-[0.18em] text-emerald-300 font-medium">
            ...
            <p className="text-white/65 text-base max-w-md leading-relaxed">
              Sign in to manage shifts, run trainings, track your activity, and keep
              Roblox's freshest Ro-Store running smooth.
            </p>
          ...
          <p className="text-xs text-white/30">
            © {new Date().getFullYear()} Shoply Shopping · Powered by Fluxcore
          </p>
        </div>
      </div>
        ...
        <div className="relative w-full max-w-sm">
          ...
          <div className="lg:hidden text-center mb-8 space-y-3 animate-fade-in">
            ...
            <div className="flex flex-col leading-none items-center">
              <span className="text-xl font-bold tracking-wide">SHOPLY</span>
              <span className="text-[10px] text-sky-300/70 tracking-[0.25em] mt-1">SHOPPING</span>
            </div>
          </div>
            ...
            <div className="space-y-6 animate-fade-in">
              <div className="space-y-2">
                ...
                <p className="text-sm text-white/55">
                  Use your Roblox account to enter the Shoply staff portal.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full h-12 bg-transparent border-white/15 text-white hover:bg-white/5 hover:text-white hover:border-emerald-400/40 transition-all"
                >
            ...
            <div className="space-y-6 animate-scale-in">
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full h-12 bg-gradient-to-br from-sky-300 to-sky-500 hover:from-sky-200 hover:to-sky-400 text-sky-950 font-semibold"
                >
          ...
          {state.step === "success" && (
            <div className="space-y-6 text-center animate-fade-in">
              {settingSession ? (
                ...
                <>
                  <div className="w-16 h-16 rounded-full bg-emerald-400/10 flex items-center justify-center mx-auto animate-scale-in">
